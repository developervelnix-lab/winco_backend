                        ...
                        <div class="row g-4" style="padding: 0 25px 25px 25px;">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel-content">
                                    ...
                                    <div class="data-row"><i class='bx bx-hash'></i> <span class="lbl">ROUND ID</span> <span class="val" style="font-size: 9px; color: #aaa;">${data.tbl_period_id || data.tbl_uniq_id}</span></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel-content bg-panel">
                                    <div class="data-row border-b"><i class='bx bx-hash'></i> <span class="lbl">CHOICE / SELECTION</span> <span class="val">${data.tbl_selection || '-'}</span></div>
