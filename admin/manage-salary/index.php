...
<head>
    ...
    <title><?php echo $APP_NAME; ?>: Salary Management</title>
        ...
        <div class="admin-main-content hide-native-scrollbar">
            <div class="dash-header">
                <div class="dash-title">
                    ...
                    <span class="dash-breadcrumb">Salary Settings</span>
                    <h1>All Salaries</h1>
                </div>
                <div class="d-flex gap-2">
                    <a href="create-salary" class="btn-modern btn-primary-modern">
                        <i class='bx bx-plus'></i> Create Salary
                    </a>
                    <button class="btn-modern p-0" style="background:transparent; color:var(--text-dim)"
            ...
            <div class="r-table-wrapper">
                <table class="r-table">
                    ...
                    <tbody>
                        <?php
                        $indexVal = 1;
                        $recharge_records_sql = "SELECT * FROM tblotherstransactions WHERE tbl_transaction_type = 'Agent Salary' ORDER BY id DESC LIMIT 20";
                        ...
                        if ($recharge_records_result && mysqli_num_rows($recharge_records_result) > 0) {
                            while ($row = mysqli_fetch_assoc($recharge_records_result)) {
                                ?>
                                <tr>
                                    <td><span style="color: var(--text-dim); font-weight: 700;">#<?php echo $indexVal; ?></span>
                                    </td>
                                    <td><span class="user-id-badge"><?php echo $row['tbl_user_id']; ?></span></td>
                                    <td><span
                                            class="amount-text">₹<?php echo number_format($row['tbl_transaction_amount'], 2); ?></span>
                                    </td>
