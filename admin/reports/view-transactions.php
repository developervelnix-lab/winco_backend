...
$f_type = mysqli_real_escape_string($conn, $_POST['f_type'] ?? $_GET['f_type'] ?? '');
    ...
    <div class="admin-main-content hide-native-scrollbar">
        <div class="dash-header">
            <div class="dash-header-left">
                ...
                <h1 class="dash-title">Transaction Ledger</h1>
            </div>
            <div class="dash-header-right">
                ...
                <button class="btn-modern btn-outline-modern" onclick="window.location.href='view-transactions.php'">
        ...
        <form method="POST" class="advanced-filter-card">
            ...
            <div class="filter-input-group">
                ...
                <div class="filter-input-wrapper">
                    ...
                    <select name="f_type" class="filter-inp">
                        <option value="">All Types</option>
                        <option value="Deposit" <?php if($f_type == "Deposit") echo "selected"; ?>>Deposit</option>
                        <option value="Withdraw" <?php if($f_type == "Withdraw") echo "selected"; ?>>Withdraw</option>
                    </select>
                </div>
            </div>
            <div class="filter-input-group">
            ...
            <table class="r-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-dim"><?php echo $row['Time']; ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="?page_num=<?php echo $i; ?>&f_username=<?php echo $f_username; ?>&f_type=<?php echo $f_type; ?>&f_date_from=<?php echo $f_date_from; ?>&f_date_to=<?php echo $f_date_to; ?>" class="pag-box <?php echo $i==$page_num?'active':''; ?>"><?php echo $i; ?></a>
                <?php endfor; ?>
            </div>
        </div>
    </div>
...
function exportData(format) {
    ...
    const f_type = document.querySelector('select[name="f_type"]').value;
    ...
    const baseUrl = `export.php?type=transactions&f_username=${f_username}&f_type=${f_type}&f_date_from=${f_date_from}&f_date_to=${f_date_to}`;
    ...
    if (format === 'excel') {
        ...
        fetch(baseUrl + '&format=json')
            ...
            .then(data => {
                ...
                doc.save('transactions_full_report_' + new Date().getTime() + '.pdf');
            });
    }
}
</script>
