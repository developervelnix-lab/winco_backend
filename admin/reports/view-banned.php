...
<head>
    ...
    <style>
        ...
        .tag-danger { background: rgba(244, 63, 94, 0.1); color: #f43f5e; border: 1px solid rgba(244, 63, 94, 0.2); }
    ...
    <div class="admin-main-content hide-native-scrollbar">
        <div class="dash-header">
            <div class="dash-header-left">
                <span class="dash-breadcrumb">Security > Reports</span>
                <h1 class="dash-title">Banned Players</h1>
            </div>
            <div class="dash-header-right">
                ...
                <button class="btn-modern btn-outline-modern" onclick="window.location.href='view-banned.php'">
        ...
        <div class="table-responsive">
            <table class="r-table">
                <thead><tr><th>No</th><th>Unique ID</th><th>User Info</th><th>Mobile</th><th>Balance</th><th>Security Status</th><th>Joined</th></tr></thead>
                <tbody>
                    <?php 
                    ...
                    <tr>
                        ...
                        <td><div class="fw-bold"><?php echo $row['tbl_user_name'] ?: 'N/A'; ?></div></td>
                        <td><?php echo $row['tbl_mobile_num']; ?></td>
                        <td class="fw-bold text-danger">₹<?php echo number_format($row['tbl_balance'], 2); ?></td>
                        <td><span class="tag-pill tag-danger">Banned</span></td>
...
function exportData(format) {
    ...
    const baseUrl = `export.php?type=banned&f_username=${f_username}&f_date_from=${f_date_from}&f_date_to=${f_date_to}`;
    ...
    if (format === 'excel') {
        ...
        fetch(baseUrl + '&format=json')
            ...
            .then(data => {
                ...
                doc.setFontSize(18);
                doc.text('Banned Players Report', 14, 15);
                doc.setFontSize(10);
                ...
                doc.save('banned_full_report_' + new Date().getTime() + '.pdf');
            });
    }
}
</script>
